...
public abstract class BaseHand : MonoBehaviour
{
    ...
    // cpr pose for hand
    [SerializeField] protected Pose CPRpose = null;

    //mobilephone pose for hand
    [SerializeField] protected Pose MobilePose = null;
    ...
    public void ApplyMobilePose()
    {
        ApplyPose(MobilePose);
    }

    public void ApplyCPRPose()
    {
        ApplyPose(CPRpose);
    }
